...
{
    public class EFCrudDemo
    {
        public static void EFCrud(string dataSource, string userId, string password)
        {
            ...
            try
            {
                ...
                using (EFSampleContext context = new EFSampleContext(builder.ConnectionString))
                {
                    ...
                    Task newTask = new Task() { Title = "Ship Helsinki", IsComplete = false, DueDate = DateTime.Parse("01-04-2020") };
